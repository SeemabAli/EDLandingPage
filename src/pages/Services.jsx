...
const services = [
  ...
  },
  {
    ...
    content:
      "Our online stationery store offers a comprehensive range of educational and office supplies, making it easy for students, teachers, and professionals to find what they need. From notebooks, pens, and art supplies to school essentials and office equipment, we provide high-quality products at competitive prices. Our seamless e-commerce platform ensures smooth browsing, secure payments, and fast delivery. We also offer bulk ordering options for schools and businesses, ensuring cost-effective solutions and timely shipments. With exclusive deals, seasonal discounts, and top-notch customer support, we aim to make stationery shopping effortless and affordable for everyone.",
    image:
      "https://images.unsplash.com/photo-1499951360447-b19be8fe80f5?w=500&auto=format&fit=crop&q=60",
    icon: GiPencilRuler,
  },
  {
    id: 5,
    ...
    image:
      "https://images.unsplash.com/photo-1508921340878-ba53e1f016ec?w=500&auto=format&fit=crop&q=60",
    icon: MdCampaign,
  },
  {
    id: 6,
        ...
        <div className="flex gap-4 bg-[#D4E0ED] p-2 pt-3 rounded-lg">
          {services.map(({ id, title, icon: Icon }) => (
            <button
              ...
              ${
                activeService === id
                  ? "bg-[#3E6899] text-white shadow-md"
                  : "bg-gray-200 text-dark hover:bg-[#7BB661] hover:text-white"
              }`}
            >
        ...
        {services.map(({ id, title, content, image }) => (
          ...
          >
            ...
            <div className="lg:w-1/2">
              ...
              <p className="text-gray-600 mt-4 max-w-3xl mx-auto lg:mx-0">
                {content}
              </p>
              <div className="flex flex-col lg:flex-row gap-4 mt-4 items-center">
                <button
                  onClick={() =>
                    id === 4 ? navigate("/stationery") : navigate("/pricing")
                  }
